...
public partial class DbA976eeImmitestContext : DbContext
{
    public DbA976eeImmitestContext()
    {
    }

    public DbA976eeImmitestContext(DbContextOptions<DbA976eeImmitestContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=sql8006.site4now.net;user=db_a976ee_immitest_admin;password=ImmitestUser@123;database=db_a976ee_immitest;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AppLanguage>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AppLangu__3214EC07483CC0D5");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CMS__3214EC074733F7F7");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Consulta__3214EC0778EB6850");

            entity.HasOne(d => d.Consultant).WithMany(p => p.ConsultantChargeRequests)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Consultan__Consu__2180FB33");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__EMITable__3214EC07B73648BD");

            entity.HasOne(d => d.EmiPaymentStatusNavigation).WithMany(p => p.Emitables).HasConstraintName("FK__EMITable__EmiPay__29221CFB");

            entity.HasOne(d => d.Retain).WithMany(p => p.Emitables)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__EMITable__Retain__2A164134");
        });

        modelBuilder.Entity<FavouriteConsultant>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Favourit__3214EC072E81C7AE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Help__3214EC07D96B5DCF");
        });

        modelBuilder.Entity<PaymentGeneral>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PaymentG__3214EC070B70DE34");
        });

        modelBuilder.Entity<RatingReviewConsultant>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__RatingRe__3214EC07BEF8AC11");
        ...
        modelBuilder.Entity<RetainPayment>(entity =>
        {
            ...
            entity.HasOne(d => d.RetainPaymentStatusNavigation).WithMany(p => p.RetainPayments).HasConstraintName("FK__RetainPay__Retai__2EDAF651");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Withdraw__3214EC078A89D6F1");

            entity.HasOne(d => d.Consultant).WithMany(p => p.Withdraws)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Withdraw__Consul__40058253");
        });
